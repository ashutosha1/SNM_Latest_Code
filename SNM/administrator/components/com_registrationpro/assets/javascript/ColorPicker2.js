...
function ColorPicker() {
	...
	if (windowMode) {
		...
		cp_contents += "<style>table{border:none;width:100%;height:100%;padding:0px;margin:0px;padding-bottom:30px;border-collapse:collapse;}table td {border:1px #444 solid;padding:0px;margin:0px;}</style>";
	...
	for (var i=0; i<total; i++) {
		...
		cp_contents += '<TD width=5% height=8%><div style="background-color:'+colors[i]+';cursor:pointer;text-decoration:none;width:100%;height:100%;" onclick="'+windowRef+'ColorPicker_pickColor(\''+colors[i]+'\','+windowRef+'window.popupWindowObjects['+cp.index+']);return false;"  '+mo+' ></div></TD>';
