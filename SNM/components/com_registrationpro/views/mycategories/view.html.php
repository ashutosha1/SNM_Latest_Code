...
class registrationproViewMycategories extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		//get vars
		$filter_order		= $mainframe->getUserStateFromRequest( $option.'.mycategories.filter_order', 'filter_order', 'id', 'cmd' );
		$filter_order_Dir	= $mainframe->getUserStateFromRequest( $option.'.mycategories.filter_order_Dir', 'filter_order_Dir', '', 'word' );
		$filter_state 		= $mainframe->getUserStateFromRequest( $option.'.mycategories.filter_state', 'filter_state', '*', 'word' );
		$filter 			= $mainframe->getUserStateFromRequest( $option.'.mycategories.filter', 'filter', '', 'int' );
