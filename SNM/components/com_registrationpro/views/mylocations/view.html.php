...
class registrationproViewMylocations extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		//create the toolbar
		/*JToolBarHelper::title( '<img src="components/com_registrationpro/assets/images/browser_small.png" align="absmiddle" border="0">' .JText::_( 'ADMIN_LBL_CONTROPANEL_LIST_LOCATIONS' ), 'events' );
