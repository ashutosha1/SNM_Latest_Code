...
function fValidate( f, errorMode, groupError )
{
	...
	function addLabelProperties()
	{
		...
		//########### SASHIL Regpro version : 3.1.1
		//File: components/com_registrationpro/assets/javascript/fvalidate/fValidate.core.js
		//line: 495
		//function : function addLabelProperties()
		//Issue: Showing fValidate error for label does not exist ( Label occurrence was inside ckeditor).
		
		//var labels = f.getElementsByTagName( "label" );
		var labels = jQuery( "td > label" );
