...
class registrationproModelMylocations extends JModelLegacy
{
	var $_data = null;
	var $_total = null;
	...
	function __construct()
	{
		...
		$limitstart = $mainframe->getUserStateFromRequest( $option.'mylocations_limitstart', 'limitstart', 0, 'int' );

		$this->setState('limit', $limit);
		$this->setState('limitstart', $limitstart);*/
		
		// set page limit from config setting of component
		$this->setState('limit', $mainframe->getUserStateFromRequest('com_registrationpro_locations.limit', 'limit', $mainframe->getCfg('list_limit'), 'int'));
	...
	function _buildContentOrderBy()
	{
		...
		$filter_order		= $mainframe->getUserStateFromRequest( $option.'.mylocations.filter_order', 'filter_order', 'l.ordering', 'cmd' );
		$filter_order_Dir	= $mainframe->getUserStateFromRequest( $option.'.mylocations.filter_order_Dir', 'filter_order_Dir', '', 'word' );	
